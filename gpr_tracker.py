...
class GPRTracker:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&gpr_tracker')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'GPRTracker')
        self.toolbar.setObjectName(u'GPRTracker')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GPRTracker', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/gpr_tracker/icon.png'
        self.add_action(icon_path, text=self.tr(u'GPR Tracker'),
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginVectorMenu(self.tr(u'&gpr_tracker'), action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            # TODO start GNSS reader thread
            # dockwidget may not exist if:
            #    first run of plugin
            #    removed on close (see self.onClosePlugin method)
            if self.dockwidget == None:
                # Create the dockwidget (after translation) and keep reference
                self.dockwidget = GPRTrackerDockWidget(self)
